...
beer_m2_int2_bst_BIC_impv  = func_fit_get_met(beer_m2_int2_imprv, dir = "backward", crit = "AIC")

# store the before and after metrics in a dataframe
metrics_bfr_afr = rbind("before" = beer_models_metrics[4,],
                        "after"  = beer_m2_int2_bst_BIC_impv$metrics_v)
...
model_afr = beer_m2_int2_bst_BIC_impv$model_bst
...
grid.arrange(bfr_plot, afr_plot, nrow = 1, ncol = 2, heights = c(2.5), top = textGrob("Fitted Vs Actual",gp=gpar(fontsize=20,font=3)))
