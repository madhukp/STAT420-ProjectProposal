...
There are many brew enthusiast who like to brew beer in home. To make a good beer or to improve a receipe over many tries it is essential to capture several readings during and after the brewing process which requires one to buy costly sensors or measuring gadgets. Through this study we want to check if we can eliminate any sensors or measuring gadgets. Particularly we intend to analyze and see if we can make predictions of one of the parameters namely - ABV - from other readings and do away with any measuring gadgets for it.
